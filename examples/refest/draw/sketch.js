...
function setup() {
  ...
  // var kinectronIpAddress2 = "172.16.222.247"; // FILL IN YOUR KINECTRON IP ADDRESS HERE

  

  // var kinectronIpAddress1 = "172.16.236.174"; // FILL IN YOUR KINECTRON IP ADDRESS HERE
  
  // kinectron1 = new Kinectron(kinectronIpAddress2);
  // kinectron2 = new Kinectron(kinectronIpAddress1);

  var kinectron1 = new Kinectron("192.168.0.26");
  var kinectron2 = new Kinectron("192.168.0.25");

  // var kinectron1 = new Kinectron("ch1", {  // enter the username to connect to
  ...
  // var kinectron2 = new Kinectron("aw1", {  // enter the username to connect to
  //   "host": "liveweb.itp.io", // your personal peer server
  //   "port": "9000", // your portnumber
  //   "path": "/", // your path
  //   "secure": "true" // include parameters per peer.js documentation 
